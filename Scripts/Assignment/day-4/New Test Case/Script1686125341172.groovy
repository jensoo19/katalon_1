...
WebUI.setText(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/input_Username_username'), 'Adn')
...
WebUI.click(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/p_Groot Khalid'))
